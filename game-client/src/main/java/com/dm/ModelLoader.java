...
public class ModelLoader {
    ...
    public static void decodeType3(Model def, byte[] var1)
    {
        ...
        if (var11 > 0)
        {
            ...
            {
                byte var29 = def.textureRenderTypes[var28] = var2.readSignedByte();
                if (var29 == 0)
                {
                    ++var25;
                }
        ...
        def.triangleFaceCount = var10;
        def.texturesCount = var11;
        def.verticesX = new int[var9];
        def.verticesY = new int[var9];
        def.verticesZ = new int[var9];
        def.trianglePointsX = new int[var10];
        def.trianglePointsY = new int[var10];
        def.trianglePointsZ = new int[var10];
        if (var17 == 1)
        {
        ...
        if (var12 == 1)
        {
            def.faceRenderType = new int[var10];
        }
        ...
        if (var15 == 1)
        {
            def.triangleSkinValues = new int[var10];
        }
        ...
        if (var11 > 0)
        {
            def.texTriangleX = new short[var11];
            def.texTriangleY = new short[var11];
            def.texTriangleZ = new short[var11];
        }
        ...
        {
            def.faceColors[var51] = (short) var2.readUShort();
            if (var12 == 1)
            {
                def.faceRenderType[var51] = var3.readSignedByte();
            }
            ...
            if (var15 == 1)
            {
                def.triangleSkinValues[var51] = var6.readUnsignedByte();
            }
        ...
        for (var55 = 0; var55 < var10; ++var55)
        {
            ...
            if (var56 == 1)
            {
                ...
                var54 = var53;
                def.trianglePointsX[var55] = var51;
                def.trianglePointsY[var55] = var52;
                def.trianglePointsZ[var55] = var53;
            }
            ...
            if (var56 == 4)
            {
                ...
                var54 = var53;
                def.trianglePointsX[var55] = var51;
                def.trianglePointsY[var55] = var57;
                def.trianglePointsZ[var55] = var53;
            }
        }
        ...
        for (var55 = 0; var55 < var11; ++var55)
        {
            ...
            if (var56 == 0)
            {
                def.texTriangleX[var55] = (short) var2.readUShort();
                def.texTriangleY[var55] = (short) var2.readUShort();
                def.texTriangleZ[var55] = (short) var2.readUShort();
            }
        }
    ...
    public static void decodeType2(Model def, byte[] var1)
    {
        ...
        {
            def.faceColors[var40] = (short) var4.readUShort();
            if (var12 == 1)
            {
                var41 = var5.readUnsignedByte();
                if ((var41 & 1) == 1)
                {
                    def.faceRenderType[var40] = 1;
                    var2 = true;
                }
                else
                {
                    def.faceRenderType[var40] = 0;
                }
            ...
            if (var15 == 1)
            {
                def.triangleSkinValues[var40] = var8.readUnsignedByte();
            }
        }
        ...
        for (var44 = 0; var44 < var10; ++var44)
        {
            ...
            if (var45 == 1)
            {
                ...
                var43 = var42;
                def.trianglePointsX[var44] = var40;
                def.trianglePointsY[var44] = var41;
                def.trianglePointsZ[var44] = var42;
            }
            ...
            if (var45 == 4)
            {
                ...
                var43 = var42;
                def.trianglePointsX[var44] = var40;
                def.trianglePointsY[var44] = var46;
                def.trianglePointsZ[var44] = var42;
            }
        }
        ...
        for (var44 = 0; var44 < var11; ++var44)
        {
            ...
            def.texTriangleX[var44] = (short) var4.readUShort();
            def.texTriangleY[var44] = (short) var4.readUShort();
            def.texTriangleZ[var44] = (short) var4.readUShort();
        }
        ...
        if (def.textureCoords != null)
        {
            ...
            for (var45 = 0; var45 < var10; ++var45)
            {
                ...
                if (var46 != 255)
                {
                    if (def.trianglePointsX[var45] == (def.texTriangleX[var46] & '\uffff') && def.trianglePointsY[var45] == (def.texTriangleY[var46] & '\uffff') && def.trianglePointsZ[var45] == (def.texTriangleZ[var46] & '\uffff'))
                    {
    ...
    public static void decodeType1(Model def, byte[] var1)
    {
        ...
        if (var11 > 0)
        {
            ...
            {
                byte var27 = def.textureRenderTypes[var26] = var2.readSignedByte();
                if (var27 == 0)
                {
                    ++var23;
                }
        ...
        {
            def.faceColors[var49] = (short) var2.readUShort();
            if (var12 == 1)
            {
                def.faceRenderType[var49] = var3.readSignedByte();
            }
            ...
            if (var15 == 1)
            {
                def.triangleSkinValues[var49] = var6.readUnsignedByte();
            }
        ...
        for (var53 = 0; var53 < var10; ++var53)
        {
            ...
            if (var54 == 1)
            {
                ...
                var52 = var51;
                def.trianglePointsX[var53] = var49;
                def.trianglePointsY[var53] = var50;
                def.trianglePointsZ[var53] = var51;
            }
            ...
            if (var54 == 4)
            {
                ...
                var52 = var51;
                def.trianglePointsX[var53] = var49;
                def.trianglePointsY[var53] = var55;
                def.trianglePointsZ[var53] = var51;
            }
        }
        ...
        for (var53 = 0; var53 < var11; ++var53)
        {
            ...
            if (var54 == 0)
            {
                def.texTriangleX[var53] = (short) var2.readUShort();
                def.texTriangleY[var53] = (short) var2.readUShort();
                def.texTriangleZ[var53] = (short) var2.readUShort();
            }
        }
    ...
    public static void decodeOldFormat(Model def, byte[] var1)
    {
        ...
        {
            def.faceColors[var38] = (short) var4.readUShort();
            if (var12 == 1)
            {
                var39 = var5.readUnsignedByte();
                if ((var39 & 1) == 1)
                {
                    def.faceRenderType[var38] = 1;
                    var2 = true;
                }
                else
                {
                    def.faceRenderType[var38] = 0;
                }
            ...
            if (var15 == 1)
            {
                def.triangleSkinValues[var38] = var8.readUnsignedByte();
            }
        }
        ...
        for (var42 = 0; var42 < var10; ++var42)
        {
            ...
            if (var43 == 1)
            {
                ...
                var41 = var40;
                def.trianglePointsX[var42] = var38;
                def.trianglePointsY[var42] = var39;
                def.trianglePointsZ[var42] = var40;
            }
            ...
            if (var43 == 4)
            {
                ...
                var41 = var40;
                def.trianglePointsX[var42] = var38;
                def.trianglePointsY[var42] = var44;
                def.trianglePointsZ[var42] = var40;
            }
        }
        ...
        for (var42 = 0; var42 < var11; ++var42)
        {
            ...
            def.texTriangleX[var42] = (short) var4.readUShort();
            def.texTriangleY[var42] = (short) var4.readUShort();
            def.texTriangleZ[var42] = (short) var4.readUShort();
        }
        ...
        if (def.textureCoords != null)
        {
            ...
            for (var43 = 0; var43 < var10; ++var43)
            {
                ...
                if (var44 != 255)
                {
                    if (def.trianglePointsX[var43] == (def.texTriangleX[var44] & '\uffff') && def.trianglePointsY[var43] == (def.texTriangleY[var44] & '\uffff') && def.trianglePointsZ[var43] == (def.texTriangleZ[var44] & '\uffff'))
                    {
