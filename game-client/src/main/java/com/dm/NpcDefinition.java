...
public final class NpcDefinition {
    ...
    static NpcDefinition lookup(int npcId) {
        ...
        switch (npcId) {
            ...
            case 6481:
                entityDef.name = "Mac";
                entityDef.description = "Only the most knowledgeable players of  are worthy of such a cape.".getBytes();
