...
final class BZip2Decompressor {
	...
	private static void method226(BZip2DecompressionState class32) {
	...
	private static void method227(BZip2DecompressionState class32) {
		int k8 = 0;
		int ai[] = null;
		int ai1[] = null;
		int ai2[] = null;
		...
		if (BZip2DecompressionState.anIntArray587 == null)
			BZip2DecompressionState.anIntArray587 = new int[class32.anInt578 * 0x186a0];
		boolean flag19 = true;
		while (flag19) {
			...
			for (int k5 = ai2[l7 - ai1[i7]]; k5 != l4; )
				if (k5 == 0 || k5 == 1) {
					...
					BZip2DecompressionState.anIntArray587[i6] = class32.aByteArray591[byte6 & 0xff] & 0xff;
					i6++;
					if (j5 == 0) {
						i5++;
						j5 = 50;
			...
			for (int l2 = 0; l2 < i6; l2++) {
				...
				BZip2DecompressionState.anIntArray587[class32.anIntArray585[byte7 & 0xff]] |= l2 << 8;
				class32.anIntArray585[byte7 & 0xff]++;
			}

			class32.anInt581 = BZip2DecompressionState.anIntArray587[class32.anInt580] >> 8;
			class32.anInt584 = 0;
			class32.anInt581 = BZip2DecompressionState.anIntArray587[class32.anInt581];
	...
	private static byte method228(BZip2DecompressionState class32) {
		return (byte) method230(8, class32);
	}

	private static byte method229(BZip2DecompressionState class32) {
		return (byte) method230(1, class32);
	}

	private static int method230(int i, BZip2DecompressionState class32) {
		int j;
		do {
	...
	private static void method231(BZip2DecompressionState class32) {
		class32.anInt588 = 0;
		for (int i = 0; i < 256; i++)
	...
	private static final BZip2DecompressionState aClass32_305 = new BZip2DecompressionState();
