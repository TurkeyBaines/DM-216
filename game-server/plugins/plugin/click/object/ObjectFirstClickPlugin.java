...
import com.dm.content.activity.impl.fightcaves.FightCaves;
import com.dm.content.activity.impl.kraken.KrakenActivity;
import com.dm.content.activity.impl.pestcontrol.PestControlLobby;
...
import com.dm.game.action.impl.DoorAction;
import com.dm.game.action.impl.LadderAction;
import com.dm.game.action.impl.LeverAction;
import com.dm.game.action.impl.RevShortcutAction;
import com.dm.game.event.impl.ObjectClickEvent;
import com.dm.game.plugin.PluginContext;
import com.dm.game.task.impl.ChopVineTask;
import com.dm.game.task.impl.ObjectReplacementEvent;
import com.dm.game.task.impl.SteppingStoneTask;
...
import com.dm.game.world.entity.combat.hit.HitIcon;
import com.dm.game.world.entity.combat.hit.Hitsplat;
...
//                PersonalStore.openMenu(player);
           ...
           /* Altar of the occult */
            ...
            case 24452:
                if (!PlayerRight.isModerator(player)) {
                    player.dialogueFactory.sendStatement("Only privileged staff members of Dead Men can access this!").execute();
                    return true;
                }
