...
public final class ClientPackets {
    ...
    public static final int FOURTH_ITEM_OPTION = 41;
    ...
    public static final int GAMBLE_PLAYER = 136;
    ...
    public static final int NPC_DROP_VIEWER = 26;
