package com.dm.util.tools.wiki.impl;
...
import com.dm.util.tools.wiki.parser.WikiTable;
import com.dm.util.tools.wiki.parser.WikiTableParser;
...
import static com.dm.game.world.entity.combat.CombatConstants.BONUS_CONFIG_FIELD_NAMES;
