...
public class Pets {
    ...
    public static boolean onSpawn(Player player, int item, boolean drop) {
        ...
        if (!drop) {
            ...
            World.sendMessage("<icon=11> <col=FF0000>Dead Men: <col=" + player.right.getColor() + ">" + player.getName() + "</col> has just received a pet " + pet.getName() + "!");
