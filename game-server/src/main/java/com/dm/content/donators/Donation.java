package com.dm.content.donators;
...
public class Donation {
    ...
    public void redeem(DonatorBond bond) {
        ...
        World.sendMessage("<col=CF2192>Dead Men: <col=" + player.right.getColor() + ">" + player.getName() + " </col>has opened <col=CF2192>" + Utility.formatEnum(bond.name()) + "");
        updateRank(false);
    }
