package com.dm.content.activity.randomevent.impl;


import com.dm.content.activity.randomevent.RandomEvent;
...
public class GenieEvent extends RandomEvent {
    ...
    protected boolean clickNpc(Player player, NpcInteractionEvent event) {
        ...
        if (event.getOpcode() == 0) {
            ...
            player.dialogueFactory.sendNpcChat(id, "Take this lamp as a token of appreciation for playing", "Dead Men.").onAction(() -> {
