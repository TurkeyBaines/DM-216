package com.dm.content.preloads.impl;
 ...
 * @author Daniel
 */
public class ZerkerMeleePreload implements Preload {
    @Override
    public String title() {
        return "<icon=23> Zerker Melee";
    }
    ...
    public Item[] equipment() {
      ...
      /* CHEST_SLOT  */ new Item(1127), // RUNE PLATEBODY
