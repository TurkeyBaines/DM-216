package com.dm.content.clanchannel.channel;

import com.dm.Config;
import com.dm.content.clanchannel.*;
...
import static com.dm.content.clanchannel.channel.ClanManagement.*;
...
public class ClanChannelHandler {
    ...
    public static void connect(Player player, String owner) {
        ...
        if (!channel.getOwner().equals("unix") && channel.activeSize() >= 80) {
