package com.dm.content.bot.botclass.impl;
...
import static com.dm.game.world.entity.combat.attack.FormulaFactory.getModifiedMaxHit;
...
public class PureMelee extends SimplifiedListener<Player> implements BotClass {
    ...
    public Item[] inventory() {
        return new Item[] {
            new Item(12695), new Item(391), new Item(391), new Item(391),
            new Item(3024), new Item(391), new Item(391), new Item(391),
            new Item(3024), new Item(391), new Item(391), new Item(391),
            new Item(3024), new Item(391), new Item(391), new Item(391),
            new Item(3024), new Item(391), new Item(391), new Item(391),
            new Item(391), new Item(391), new Item(13652), new Item(3144),
    ...
    public void pot(Player target, PlayerBot bot) {
        ...
        } else if (checkSkill(bot, Skill.ATTACK, 71)
