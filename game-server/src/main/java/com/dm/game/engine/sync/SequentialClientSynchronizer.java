...
import com.dm.game.engine.sync.task.NpcPostUpdateTask;
import com.dm.game.engine.sync.task.NpcUpdateTask;
import com.dm.game.engine.sync.task.PlayerPostUpdateTask;
import com.dm.game.engine.sync.task.PlayerUpdateTask;
