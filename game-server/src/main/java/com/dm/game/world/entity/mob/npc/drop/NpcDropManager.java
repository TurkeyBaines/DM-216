package com.dm.game.world.entity.mob.npc.drop;

import com.dm.Config;
import com.dm.content.CrystalChest;
...
import com.dm.content.skill.impl.prayer.BoneData;
...
import com.dm.net.packet.out.SendScreenshot;
import com.dm.util.Items;
import com.dm.util.RandomGen;
...
//            }
            ...
            if (killer.settings.dropNotification && item.getValue() > 1_000_000) {
                ...
                World.sendMessage("<col=BA383E>Dead Men: <col=" + killer.right.getColor() + ">" + killer.getName() + " </col>has just received " + Utility.getAOrAn(name) + " <col=BA383E>" + name + " </col>from <col=BA383E>" + npc.getName() + "</col>!");
    ...
    private static void handleMessages(Player player, Npc npc, Item item) {
        ...
        if (player.settings.dropNotification && item.getValue() > 1_000_000) {
            ...
            World.sendMessage("<col=BA383E>Dead Men: <col=" + player.right.getColor() + ">" + player.getName() + " </col>has just received " + Utility.getAOrAn(name) + " <col=BA383E>" + name + " </col>from <col=BA383E>" + npc.getName() + "</col>!");
