package com.dm.game.world.entity.mob.npc;

import com.dm.game.world.entity.combat.strategy.CombatStrategy;
import com.dm.game.world.entity.combat.strategy.npc.boss.*;
import com.dm.game.world.entity.combat.strategy.npc.boss.armadyl.FlightKilisa;
import com.dm.game.world.entity.combat.strategy.npc.boss.armadyl.FlockleaderGeerin;
import com.dm.game.world.entity.combat.strategy.npc.boss.armadyl.KreeArra;
import com.dm.game.world.entity.combat.strategy.npc.boss.armadyl.WingmanSkree;
import com.dm.game.world.entity.combat.strategy.npc.boss.dagannoths.DagannothPrime;
import com.dm.game.world.entity.combat.strategy.npc.boss.dagannoths.DagannothRex;
import com.dm.game.world.entity.combat.strategy.npc.boss.dagannoths.DagannothSupreme;
import com.dm.game.world.entity.combat.strategy.npc.boss.dagannoths.Spinolyp;
import com.dm.game.world.entity.combat.strategy.npc.boss.kril.Balfrug;
import com.dm.game.world.entity.combat.strategy.npc.boss.kril.Tstanon;
import com.dm.game.world.entity.combat.strategy.npc.boss.kril.Zakln;
import com.dm.game.world.entity.combat.strategy.npc.boss.magearena.Derwen;
import com.dm.game.world.entity.combat.strategy.npc.boss.magearena.Justiciar;
import com.dm.game.world.entity.combat.strategy.npc.boss.magearena.Porazdir;
import com.dm.game.world.entity.combat.strategy.npc.boss.scorpia.Scorpia;
