package com.dm.game.world.entity.combat.attack.listener;
...
public final class CombatListenerManager {
    ...
    public static void load() {
        loadItems("com.dm.game.world.entity.combat.attack.listener.item");
        loadNpcs("com.dm.game.world.entity.combat.attack.listener.npc");
    }
